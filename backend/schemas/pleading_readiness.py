...
class ReadinessIssueCode(StrEnum):
    ...
    CLAIM_AMOUNT_WITHOUT_AMOUNT_BASIS = "CLAIM_AMOUNT_WITHOUT_AMOUNT_BASIS"
    CLAIM_HAS_NO_SUPPORTING_FACT = "CLAIM_HAS_NO_SUPPORTING_FACT"
    ISSUE_HAS_NO_SUPPORTING_FACT = "ISSUE_HAS_NO_SUPPORTING_FACT"
    FACT_HAS_NO_ACCEPTED_EVIDENCE = "FACT_HAS_NO_ACCEPTED_EVIDENCE"
    STALE_INPUT = "STALE_INPUT"
    LEGACY_CLAIM_SOURCE = "LEGACY_CLAIM_SOURCE"
